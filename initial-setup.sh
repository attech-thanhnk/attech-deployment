...
if command -v envsubst &> /dev/null; then
    envsubst '$FRONTEND_DOMAIN $FRONTEND_DOMAIN_WWW $API_DOMAIN $CLIENT_MAX_BODY_SIZE' < "${SCRIPT_DIR}/nginx/proxy/conf.d/production.conf.template" > "${SCRIPT_DIR}/nginx/proxy/conf.d/production.conf"
